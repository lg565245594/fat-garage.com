...
开放性的网络发展品牌，最为成功的例子应该是比特币。开源社区的话当属Github，它成功的激励了社区的大规模自发协作。但与开源社区不同的是，诸如以太坊这样的开放网络，加密货币角色的介入促进了开源货币化。你根据做出的贡献拿到相应的token，也就是说，你成为了这个网络的贡献者和股东，是不是有了共同进退的感觉？
...
<iframe height="80" width="260" src="https://www.ximalaya.com/thirdparty/player/sound/player.html?id=228234760&type=red" frameborder=0 allowfullscreen></iframe>
